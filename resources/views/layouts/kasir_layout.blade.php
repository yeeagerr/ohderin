...
<body class="bg-gray-50">
    ...
    <div id="mainContent" class="flex h-screen">
        ...
        <div class="w-20 bg-indigo-600 text-white flex flex-col items-center py-6 space-y-4 flex-shrink-0">
            ...
            <a href="{{ route('kasir.pos') }}" class="flex flex-col items-center p-3 {{ request()->routeIs('kasir.pos') ? 'bg-indigo-500' : 'hover:bg-indigo-500' }} rounded-xl w-14 transition-colors">
            ...
            <a href="{{ route('kasir.order') }}" class="flex flex-col items-center p-3 {{ request()->routeIs('kasir.order') ? 'bg-indigo-500' : 'hover:bg-indigo-500' }} rounded-xl w-14 transition-colors">
                <svg class="w-6 h-6 mb-1" fill="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Group 2: Master Data -->
            <a href="#" class="flex flex-col items-center p-3 hover:bg-indigo-500 rounded-xl w-14 transition-colors">
                <svg class="w-6 h-6 mb-1" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('kasir.stock-opnames.index') }}" class="flex flex-col items-center p-3 {{ request()->routeIs('kasir.stock-opnames.*') ? 'bg-indigo-500' : 'hover:bg-indigo-500' }} rounded-xl w-14 transition-colors">

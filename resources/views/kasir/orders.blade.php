        ...
        <div class="flex-1 flex flex-col bg-gray-50 min-w-0">
                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 lg:gap-4">
                    ...
                    <div class="flex items-center space-x-2 lg:space-x-3">
                        ...
                        <div class="relative flex-1 lg:flex-none">
                            ...
                            <input type="text" id="ordersSearchInput" placeholder="Cari order..." class="w-full lg:w-48 xl:w-64 pl-9 lg:pl-10 pr-4 py-2 lg:py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent text-sm">
                        </div>
                        <a href="{{ route('kasir.pos') }}" class="px-3 lg:px-4 py-2 lg:py-2.5 bg-orange-500 text-white rounded-xl hover:bg-orange-600 font-medium transition flex items-center text-sm">
            ...
            <div class="bg-white border-b border-gray-200 px-3 lg:px-4">
                <div id="statusTabs" class="flex space-x-1 overflow-x-auto scrollbar-hide py-1">
                    ...
                    <button class="px-3 lg:px-4 py-2 lg:py-2.5 bg-orange-500 text-white rounded-lg font-medium whitespace-nowrap text-xs lg:text-sm flex items-center">
                        All
                        <span class="ml-1.5 lg:ml-2 bg-orange-400 px-1.5 lg:px-2 py-0.5 rounded-full text-[10px] lg:text-xs">...</span>
                    </button>
                </div>
            </div>
